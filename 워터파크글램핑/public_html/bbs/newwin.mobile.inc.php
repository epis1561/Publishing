...
<style type="text/css">
	/* 팝업레이어 */
    #hd_pop { display:flex; flex-wrap: wrap; position:absolute; right: 5px; top: 60px; max-width:250px; z-index:10000; } 
	/* .popup { position:absolute; left: 5px; top: 60px; z-index:1000; max-width:350px; } */
	.popup img { width:250px; }
	.hd_pops_footer {padding:10px 0;background:#000;color:#fff;text-align:right}
	.hd_pops_footer button {margin-right:5px;padding:5px 3px;border:0;background:#393939;color:#fff;cursor:pointer;}
</style>
<!-- 팝업레이어 시작 { -->
    <div id="hd_pop">
    <!--h2>팝업레이어 알림</h2-->
...
for ($i=0; $nw=sql_fetch_array($result); $i++)
{
    ...
    $z = "65000" - $nw['nw_1'];
?>
<div class="popup" id="hd_pops_<?php echo $nw['nw_id'] ?>" style="z-index:<?= $z ?>">
