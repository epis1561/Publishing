...
<div class="new_reser">
			<ul>
				<li class="ddanyo_icon">
					<a href="https://booking.ddnayo.com/booking-calendar-status?accommodationId=15915" target="_blank">
						<i class="icon">홈페이지</i>
						<span class="txt">예약 바로가기</span>
					</a>
				</li>
				<!-- <li class="naver_icon">
					<a href="https://booking.naver.com/booking/3/bizes/850038" target="_blank">
