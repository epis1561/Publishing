...
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" novalidate method="post" action="/adminFunc/event" onsubmit="return submitCheck(this)">	
	...
	<div class="item form-group">
		...
		<div class="col-md-6 col-sm-6"><textarea name="content" id="ir1" style="width:100%; height:400px;"></textarea></div>		
	</div>
	<div class="ln_solid"></div>
	<div class="item form-group">
		<a href="javascript:cancel();"><button type="button" class="btn btn-primary">Cancel</button></a>
