...
<style type="text/css">
	/* 팝업레이어 */
	.containerPop { display:flex; flex-wrap: wrap; position:absolute; left: 16%; top: 120px; max-width:1700px; z-index:10000; }
...
<?php // if ($_SERVER['REMOTE_ADDR'] == "59.29.3.210") { ?>
	<style>
		.popupBox {position: absolute;top: 130px;right: 40px;width: 350px;z-index: 10000;} 
