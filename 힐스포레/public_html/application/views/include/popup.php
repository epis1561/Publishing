...
<style type="text/css">
	/* 팝업레이어 */
	.containerPop { display:flex; flex-wrap: wrap; position:absolute; right: 23%; top: 150px; max-width:1800px; z-index:10000; }
...
<?php // if ($_SERVER['REMOTE_ADDR'] == "59.29.3.210") { ?>
	<style>
		.popupBox {position: absolute;top: 165px;right: 1%;width: 350px;z-index: 10000;} 
