...
foreach ($data['slist'] as $row)
{
	...
	$r_pro17 = ($row['r_pro17'] == 1) ? 'checked="checked"' : "";
	$r_pro18 = ($row['r_pro18'] == 1) ? 'checked="checked"' : "";
	$r_pro19 = ($row['r_pro19'] == 1) ? 'checked="checked"' : "";
	$r_pro20 = ($row['r_pro20'] == 1) ? 'checked="checked"' : "";
				...
				<div class="cp_sch">
					<div class="program">
						...
						<div class="rightbox dup" id="dup">
							<label for="r_pro17">
							<input type="checkbox" name="r_pro17" id="r_pro17" <?echo $r_pro17?> >미니축구,야구,미니골프,미니양궁,농구,RC카,에어바운스 등의 체험</label>
						</div>
					</div>
					...
					<div class="rightbox">
						<label for="r_pro18"><input type="checkbox" name="r_pro18" id="r_pro18" <?echo $r_pro18?> >축구 클리닉,싸커 챌린지,미니축구,포천 관광지 체험 등으로 구성</label>
					</div>
								</div>
								<div class="program">
					<div class="leftbox">· 여름 스포츠 물 놀이터</div>
					<div class="rightbox">
						<label for="r_pro19"><input type="checkbox" name="r_pro19" id="r_pro19" <?echo $r_pro19?> >수중축구, 워터 슬라이드, 워터 밤, 물총놀이 등으로 구성</label>
					</div>
								</div>
								<div class="program">
					<div class="leftbox">· 가족과 함께하는 축핑<br>(축구+캠핑)</div>
					<div class="rightbox">
						<label for="r_pro20"><input type="checkbox" name="r_pro20" id="r_pro20" <?echo $r_pro20?> >미니축구, 명랑 운동회, 오늘은 아빠가 요리사, 별밤 콘서트 등으로 구성</label>
					</div>
								</div>
				</div>
			</div>
