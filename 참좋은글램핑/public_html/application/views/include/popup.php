...
<style type="text/css">
	/* 팝업레이어 */
	.containerPop { display:flex; flex-wrap: wrap; position:absolute; left: 12%; top: 260px; max-width:1800px; z-index:10000; }
...
<?php // if ($_SERVER['REMOTE_ADDR'] == "59.29.3.210") { ?>
	<style>
		.popupBox {position: absolute;top: 275px;right: 8%;width: 350px;z-index: 10000;} 
		...
		<div class="swiper popup-slide">
			...
			<!-- <div class="swiper-pagination"></div> -->
			 ...
			 <ul class="swiper-button">
				<li class="swiper-button-prev1"><img src="/images/popup/arrow_left2.png" alt="이전"></li>
				<li class="swiper-button-next1"><img src="/images/popup/arrow_right2.png" alt="다음"></li>
