...
<head>
	...
	<link rel="stylesheet" href="../../CSS/package2.css">
...
<body>
	...
	<div class="subgnb">
		<ul class="subgnb1">
			<li>레이싱카트 + 서바이벌 + ATV + 바비큐(식당)</li>
		</ul>
	</div>
	<div class="Packagewrap">
		<div class="imgbox">
			<!-- <div class="wowrap wow fadeInRight animated" style="display:none">
				<h2>레이싱카트 + 서바이벌 + ATV + 바비큐(무제한)  <span>Package</span></h2>
				<div class="package " style="">
					<img src="../../images/package/04_01.jpg" alt="">
					<div class="Packagetext">
						 <h3>서바이벌+ATV에 대한 설명입니다.</h3>
						<p> 
							<span style="font-weight:bold; font-size:18px;">※레이싱카트</span><br><br>
							
							이용시간 : 약 10분<br>
							신장 140cm 이상 남녀에 한하여 탑승 가능<br><br>
							
							<span style="font-weight:bold; font-size:18px;">※서바이벌</span><br><br>
							
							이용인원 : 13세이상, 4인이상 부터 가능(1인당 150발)<br>
							근거리 사격 절대금지(사격 최단거리 10M)<br>
							게임장 안, 밖에서는 무조건 교관 통제에 따라주시기 바랍니다.<br><br>

							<span style="font-weight:bold; font-size:18px;">※ATV</span><br><br>
							
							원동기 이상의 면허증 소지자에 한하여 이용 가능<br>
							1시간 단위로 이용가능<br><br>

							<span style="font-weight:bold; font-size:18px;">※바비큐(무제한)</span><br><br>
			...
			<div class="wowrap wow fadeInRight animated" style="display:none">
				<h2>레이싱카트 + 서바이벌 + ATV + 바비큐(식당) <span>Package</span></h2>
				<div class="package " style="">
				
					<img src="../../images/package/04_02.jpg" alt="">
					<div class="Packagetext">
						<!-- <h3>서바이벌+ATV에 대한 설명입니다.</h3> -->
						<p> 
...
$(document).ready(function(){
	$('.gnb li').eq(2).css("border-bottom","3px solid #978d6e");
