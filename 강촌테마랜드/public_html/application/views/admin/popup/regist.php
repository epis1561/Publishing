...
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" novalidate method="post" action="/adminFunc/popup" onsubmit="return submitCheck(this)">	
...
<script>
	...
	function cancel() {
		if (confirm("입력을 취소하고 목록페이지로 돌아가시겠습니까?")) document.location.href = '/admin/popup';
	}
</script>