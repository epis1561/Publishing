...
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" novalidate method="post" action="/adminFunc/popup/<?= $idx ?>" onsubmit="return submitCheck(this)">
