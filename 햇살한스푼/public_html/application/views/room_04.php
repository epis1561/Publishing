...
?>
			...
			<div class="swiper-wrap">
				<div class="swiper">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<img src="/images/room04/01_12.jpg" alt="">
						</div>
		...
		<div class="swiper-wrap">
			<div class="swiper">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<img src="/images/room04/m/01_12.jpg" alt="">
					</div>
	...
	<div class="roomprewrap">
		...
		스위밍 스파에서 일상에 지친 근심걱정을 파도에 흘려보내시길 바랍니다.
		</p>
	</div>
	<div class="flexbox">
		<div class="img_box">
		...
		<div class="textbox">
			<ul>
				<li>
					<p>Type.</p> <span>햇살(스위밍스파)</span>
				</li>
				<li>
					<p>Area.</p> <span>55평(182㎡) <br>분리형, 침실A(더블1), 침실B(더블1), 화장실2, 개별테라스(개별바비큐 + 스위밍스파)</span>
				</li>
				<li>
					<p> Guests.</p>
					<span>
				...
				<li>
					...
					*객실 <br>
						...
						*스위밍스파 <br>
						햇살 객실만 이용가능 / 1박당 100,000원(미온수) / 찬물 이용시 50,000원 <br>
						사전예약필수(당일신청불가) / 수영복 및 구명조끼 착용 필수 <br>
						 <br>현장결제 <br><br>
    ...
    <div class="accordion_box">
		...
		<div class="panel">
		<p>객실넓이 : 55평 / 분리형, 침실A(더블1), 침실B(더블1), 화장실2, 개별테라스(개별바비큐 + 스위밍스파)</p>
		</div>
		...
		*객실 <br>
						...
						*스위밍스파 <br>
						햇살 객실만 이용가능 / 1박당 100,000원(미온수) / 찬물 이용 시 50,000원<br>
						사전예약필수(당일신청불가) / 수영복 및 구명조끼 착용 필수 <br>
						 <br>현장결제 <br><br>
