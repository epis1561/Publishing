...
<div class="new_reser">
			<ul>
				<li class="ddanyo_icon">
					<a href="https://booking.ddnayo.com/booking-calendar-status?accommodationId=7674" target="_blank">
						<i class="icon">홈페이지</i>
						<span class="txt">예약 바로가기</span>
					</a>
				</li>
				<li class="naver_icon">
					<a href="https://booking.naver.com/booking/3/bizes/218713" target="_blank">
