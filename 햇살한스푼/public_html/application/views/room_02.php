...
<script type="text/javascript">
    ddnayo.room.price.dailytable($("#room_daily_price1").get(0), {
        "id_hotel": "7674"		/* 업소 코드 */
	, "id_room_type": "55793"		/* 객실타입 코드 */
	, "su_day": 7			/* 출력일자 : 파라미터 생략시 기본 7일 최대 7일 */
    });
</script>
    </div>
    <div class="photo_wrap">
		<div class="photo_box"><img src="/images/room02/img02.jpg" alt=""></div>
		<div class="photo_box"><img src="/images/room02/img03.jpg" alt=""></div>
		<div class="photo_box"><img src="/images/room02/img04.jpg" alt=""></div>
	</div>
	<?php
include('footer.php');
?>
