...
?>
<style>
.nw_type { color:#fff; padding:5px;}
.nw_type01 { background:#33353e;}
.nw_type02 { background:#3fa5cf;}
.nw_type03 { background:#ee8100;}
.nw_type04 { background:#e30202;}
.nw_type05 { background:#108410;}
</style>
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        <th scope="row">팝업 타입<strong class="sound_only"> 필수</strong></th>
        <td>
			<input type="radio" name="nw_type" id="nw_type01" value="01" <?php if(htmlspecialchars($nw[nw_type],ENT_QUOTES) == "01") echo "checked"; ?>> <label for="nw_type01" class="nw_type nw_type01"> 01</label> &nbsp;
			<input type="radio" name="nw_type" id="nw_type02" value="02" <?php if(htmlspecialchars($nw[nw_type],ENT_QUOTES) == "02") echo "checked"; ?>> <label for="nw_type02" class="nw_type nw_type02"> 02</label> &nbsp;
			<input type="radio" name="nw_type" id="nw_type03" value="03" <?php if(htmlspecialchars($nw[nw_type],ENT_QUOTES) == "03") echo "checked"; ?>> <label for="nw_type03" class="nw_type nw_type03"> 03</label> &nbsp;
			<input type="radio" name="nw_type" id="nw_type04" value="04" <?php if(htmlspecialchars($nw[nw_type],ENT_QUOTES) == "04") echo "checked"; ?>> <label for="nw_type04" class="nw_type nw_type04"> 04</label> &nbsp;
			<input type="radio" name="nw_type" id="nw_type05" value="05" <?php if(htmlspecialchars($nw[nw_type],ENT_QUOTES) == "05") echo "checked"; ?>> <label for="nw_type05" class="nw_type nw_type05"> 05</label> &nbsp;
			<input type="radio" name="nw_type" id="nw_type06" value="image" <?php if(htmlspecialchars($nw[nw_type],ENT_QUOTES) == "image") echo "checked"; ?>> <label for="nw_type06"> image</label> &nbsp;
        </td>
    </tr>
    <tr>
