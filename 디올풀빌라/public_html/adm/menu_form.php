...
function add_menu_list(name, link, code)
{
    ...
    list += "<label for=\"pageNum_"+ms+"\"  class=\"sound_only\">pageNum<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"pageNum[]\" value=\"1\" id=\"pageNum_"+ms+"\" class=\"frm_input full_input\">";
    list += "</td>";
    ...
    list += "</td>";
	list += "<td class=\"td_itopt\">";
    list += "<label for=\"me_title_e_"+ms+"\"  class=\"sound_only\">me_title_e<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"me_title_e[]\" value=\"1\" id=\"me_title_e_"+ms+"\" class=\"frm_input full_input\">";
    list += "</td>";
	list += "<td class=\"td_odrnum\">";
    list += "<label for=\"me_title01_"+ms+"\"  class=\"sound_only\">me_title01<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"me_title01[]\" value=\"1\" id=\"me_title01_"+ms+"\" class=\"frm_input full_input\">";
    list += "</td>";
	list += "<td class=\"td_itopt\">";
    list += "<label for=\"me_title_b_"+ms+"\"  class=\"sound_only\">me_title_b<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"me_title_b[]\" value=\"1\" id=\"me_title_b_"+ms+"\" class=\"frm_input full_input\">";
    list += "</td>";
	list += "<td class=\"td_itopt\">";
    list += "<label for=\"me_title02_"+ms+"\"  class=\"sound_only\">me_title02<strong class=\"sound_only\"> 필수</strong></label>";
    list += "<input type=\"text\" name=\"me_title02[]\" value=\"1\" id=\"me_title02_"+ms+"\" class=\"frm_input full_input\">";
    list += "</td>";
    list += "<td class=\"td_mngsmall\" style=\"display:none\">";
